...
from packnet_sfm.losses.fisheye_multiview_photometric_loss_valeo_test4 import MultiViewPhotometricLoss
from packnet_sfm.models.model_utils import merge_outputs


class SelfSupModel_fisheye_valeo_testPose4(SfmModel):
    """
