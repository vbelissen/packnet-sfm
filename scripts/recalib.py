...
def parse_args():
    ...
    parser.add_argument('--save_pictures',          action='store_false')
    parser.add_argument('--save_plots',             action='store_false')
    parser.add_argument('--save_rot_tab',           action='store_false')
    parser.add_argument('--show_plots',             action='store_false')
        ...
        for i_file in range(N_files):
            ...
            def lidar_loss(i_cam1, extra_trans, extra_rot):
                if args.use_lidar and has_gt_depth[i_cam1]:
                    ...
                    world_points_gt_oldCalib = cam_old.reconstruct(gt_depth[i_cam1], frame='w')
