...
from packnet_sfm.losses.camera_distance_angle_loss import CameraDistanceAngleLoss


class CameraDistanceAngleSupModelFisheye(SelfSupModel_fisheye_valeo):
    """
    ...
    def __init__(self, velocity_loss_weight=0.1, **kwargs):
        ...
        self._camera_distance_angle_loss = CameraDistanceAngleLoss(**kwargs)
        self._camera_distance_angle_loss_weight = velocity_loss_weight
    ...
    def forward(self, batch, return_logs=False, progress=0.0):
        ...
        if self.training:
            ...
            camera_distance_angle_loss = self._camera_distance_angle_loss(output['poses'],
                                                              batch['pose_matrix_context'],
                                                              batch['same_timestep_as_origin_context'])
            output['loss'] += self._camera_distance_angle_loss_weight * camera_distance_angle_loss['loss']
        return output
