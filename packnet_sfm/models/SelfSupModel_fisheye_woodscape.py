...
from packnet_sfm.losses.fisheye_multiview_photometric_loss_woodscape import MultiViewPhotometricLoss
from packnet_sfm.models.model_utils import merge_outputs


class SelfSupModel_fisheye_woodscape(SfmModel):
    """
    ...
    def self_supervised_loss(self, image, ref_images, inv_depths, poses,
                             path_to_theta_lut, poly_coeffs, principal_point, scale_factor_y,
    ...
    def forward(self, batch, return_logs=False, progress=0.0):
        ...
        if not self.training:
            ...
            self_sup_output = self.self_supervised_loss(
                ...
                batch['intrinsics_poly_coeffs'], batch['intrinsics_principal_point'], batch['intrinsics_scale_factor_y'],
