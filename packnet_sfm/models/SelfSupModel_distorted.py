...
from packnet_sfm.losses.distorted_multiview_photometric_loss import DistortedMultiViewPhotometricLoss
...
class SelfSupModel_distorted(SfmModel):
    ...
    def __init__(self, **kwargs):
        ...
        self._photometric_loss = DistortedMultiViewPhotometricLoss(**kwargs)
