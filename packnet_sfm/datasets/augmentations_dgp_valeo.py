...
def resize_sample_image_and_intrinsics(sample, shape,
    ...
    # Scale images
    for key in filter_dict(sample, [
        'rgb', 'rgb_original', 'rgb_left', 'rgb_left_original', 'rgb_right', 'rgb_right_original'
    ]):
...
def to_tensor_sample(sample, tensor_type='torch.FloatTensor'):
    ...
    for key in filter_dict(sample, [
        'rgb', 'rgb_original', 'rgb_left', 'rgb_left_original', 'rgb_right', 'rgb_right_original', 'depth',
    ]):
