...
class SfmModel_multifocal(nn.Module):
    """
    ...
    def forward(self, batch, return_logs=False):
        ...
        return {
            ...
            'poses_temporal_context': pose_temporal_context,
            'poses_geometric_context_temporal_context': pose_geometric_context_temporal_context,
        }
