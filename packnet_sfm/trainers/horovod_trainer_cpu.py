...
from packnet_sfm.trainers.base_trainer_cpu import BaseTrainer, sample_to_cuda, sample_to_cpu
...
class HorovodTrainer(BaseTrainer):
    ...
    def train(self, dataloader, module, optimizer):
        ...
        for i, batch in progress_bar:
            ...
            batch = sample_to_cpu(batch)#sample_to_cuda(batch)
    ...
    def test(self, module):
        # Send module to GPU
        module = module.to('cpu', dtype=self.dtype)#module.to('cuda', dtype=self.dtype)
    ...
    def evaluate(self, dataloaders, module):
        ...
        for n, dataloader in enumerate(dataloaders):
            ...
            for i, batch in progress_bar:
                ...
                batch = sample_to_cpu(batch, self.dtype)
